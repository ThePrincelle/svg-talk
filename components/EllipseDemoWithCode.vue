...
const codeString = computed(() => `<ellipse 
...
<template>
  <div class="demo-with-code">
    <div class="left-side">
      <div class="svg-container">
        <svg width="200" height="200" viewBox="0 0 300 300">
          <!-- Grille de fond -->
          <defs>
            <pattern id="grid-ellipse-demo" width="20" height="20" patternUnits="userSpaceOnUse">
              <rect width="20" height="20" fill="none" stroke="#ddd" stroke-width="0.5"/>
            </pattern>
          </defs>
          <rect width="300" height="300" fill="white" />
          <rect width="300" height="300" fill="url(#grid-ellipse-demo)" />
      ...
      <div class="controls">
        <InteractiveSlider v-model="cx" label="cx (centre x)" :min="0" :max="300" />
        <InteractiveSlider v-model="cy" label="cy (centre y)" :min="0" :max="300" />
        <InteractiveSlider v-model="rx" label="rx (rayon H)" :min="0" :max="150" />
        <InteractiveSlider v-model="ry" label="ry (rayon V)" :min="0" :max="150" />
      </div>
    </div>
    ...
    <div class="right-side">
      ...
      <div class="code-display">
        <pre><code class="language-xml"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>ellipse</span> 
  ...
  <span class="token attr-name">fill</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>lightblue<span class="token punctuation">"</span></span>
